...
.from('.bg2', { rotateZ: "+30deg" , opacity: 0, ease: 'power1', duration: 1.5 })
...
.from('.bg3', { rotateZ: "-30deg" , opacity: 0, ease: 'power1', duration: 1.5 })
...
.from('.bg4', { rotateZ: "+30deg" , opacity: 0, ease: 'power1', duration: 1.5 })
